...
const Section1 = () => {
  ...
  return (
    ...
    >
      ...
      {/* Your main content goes here */}
      <div className={`${windowWidth <= 425 ? "section1-title":""} flex flex-col mt-8 md:mt-16 lg:mt-96 ml-4 md:ml-8 lg:ml-12`}>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <button onClick={()=>navigate("/register")} className="bg-[#E3BC3F] text-[#363636] px-4 py-2 rounded overflow-hidden z-10">
            SIGNUP
          ...
          <button onClick={()=>handleLogin()} className="border border-[#E3BC3F] bg-[#01162f] text-white px-4 py-2 rounded mt-4 md:mt-0 z-10">
            SIGNIN
          </button>
        </div>
      </div>
