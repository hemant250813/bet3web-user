            ...
            <form className="bg-[#01162f] p-6 rounded shadow-md text-center max-w-md mx-auto border border-gray-400">
              ...
              <div className="mb-4">
                <div className="w-full border-none text-white">
                  ...
                  >
                    <option defaultValue={"gateway"} className="text-xl" value="javascript">Select Gateway</option>
                    <option className="text-xl" value="javascript">Bank Transfer</option>
                    <option className="text-xl" value="python">Mobile Money</option>
                  </select>
                </div>
              </div>
              {error?.password && (
