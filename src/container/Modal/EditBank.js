...
import { editBank } from "../../redux/action";
import validateAddBank from "../../validation/bank/addBank";
import { ACCOUNT_TYPE } from "../../utils/constants";

const EditBank = ({ openModal, closeModal, bankDetail, init }) => {
  ...
  useEffect(() => {
    setForm({
      account_number: bankDetail?.accountNumber?.toString(),
